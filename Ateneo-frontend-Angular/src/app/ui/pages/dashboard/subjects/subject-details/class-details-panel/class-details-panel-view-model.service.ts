...
export class ClassDetailsPanelViewModelService {
    ...
    public initializeExistingClassAttendance(classData: ClassEntity, students: Student[]): StudentAttendance[] {
    ...
    public updateClass(classId: string, description: string, studentAttendance: StudentAttendance[]): Observable<IResponse> {
        const absences = this.prepareAbsencesData(studentAttendance);
